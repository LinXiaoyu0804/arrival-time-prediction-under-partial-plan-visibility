"""Post-review audit of cohort size and DG-versus-ER comparisons.

This analysis was added after reviewer-style criticism of the reconstructed
manuscript.  It only recombines archived route-level outputs; it does not
refit a model or alter the primary specification.
"""
...
def main():
    ...
    checks = {
        "status": "complete",
        "audit_type": "post_review_robustness",
    ...
    (OUT / "POST_REVIEW_AUDIT_COMPLETE.json").write_text(
